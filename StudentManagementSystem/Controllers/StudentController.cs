...
using StudentManagementStytem.Service.Utilities;
...
public class StudentController
{
    ...
    public StudentController(StudentService studentService)
    {
        ...
        this.StudentEvent += new EventDelegate(this.SuccessMessage); //event
    }
    ...
    public void AddSemesterAndCourses()
    {
        try
        {
            ...
            semesterCodeInput:
                ...
                _studentService.AddSemesterAndCourses(studentId, semesterCode, year);
